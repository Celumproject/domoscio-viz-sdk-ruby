...
###############################################
  ...
  let(:new_knowledge_graph) {
    DomoscioViz::KnowledgeGraph.create({
...
###############################################
  ...
  let(:new_knowledge_node_source) {
    DomoscioViz::KnowledgeNode.create({
...
###############################################
  ...
  let(:new_knowledge_edge) {
    DomoscioViz::KnowledgeEdge.create({
      knowledge_graph_id: new_knowledge_graph["id"],
...
###############################################
  ...
  let(:new_knowledge_node_student) {
    DomoscioViz::KnowledgeNodeStudent.create({
...
###############################################
  ...
  let(:new_rule_input) {
    DomoscioViz::RuleInput.create({
      path_rule_id: new_path_rule["id"]
    })
  }
  let(:new_rule_condition) {
    DomoscioViz::RuleCondition.create({
      path_rule_id: new_path_rule["id"],
      content: '
          [
              {
