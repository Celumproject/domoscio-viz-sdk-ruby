...
describe DomoscioViz::KnowledgeNodeStudent do
  ...
  describe 'FETCH' do
    it 'fetches all the knowledge_node_students of the company' do
      knowledge_node_students = DomoscioViz::KnowledgeNodeStudent.fetch()
  ...
  describe 'DESTROY' do
    it 'destroys the created knowledge_node_student of the company' do
      DomoscioViz::KnowledgeNodeStudent.destroy(created["id"])
    end
  end
  ...
  describe 'DESTROY_STUDENT' do
    it 'destroys the created student of the company' do
      DomoscioViz::Student.destroy(created["student_id"])
    end
  end
  ...
  describe 'FETCH_KNOWLEDGE_NODE' do
    it 'fetches then newly created student to the company' do
      created_knowledge_node = DomoscioViz::KnowledgeNode.fetch(created["knowledge_node_id"])
  ...
  describe 'DESTROY_KNOWLEDGE_GRAPH' do
    it 'destroys the created knowledge_graph of the company' do
      DomoscioViz::KnowledgeGraph.destroy(created_knowledge_node["knowledge_graph_id"])
    end
  end
