...
describe DomoscioViz::Event do
  ...
  describe 'FETCH' do
    it 'fetches all the results of the company' do
      results = DomoscioViz::Event.fetch()
  ...
  describe 'FETCH' do
    it 'fetches the knowledge_node_student for the created result' do
      kns = DomoscioViz::KnowledgeNodeStudent.fetch(created_success["knowledge_node_student_id"])
  ...
  describe 'FETCH' do
    it 'fetches the knowledge_node_student for the created result' do
      kns = DomoscioViz::KnowledgeNodeStudent.fetch(created_success2["knowledge_node_student_id"])
  ...
  describe 'DESTROY' do
    it 'destroys the created results of the company' do
      ...
      DomoscioViz::Event.destroy(created_failure["id"])
      DomoscioViz::Event.destroy(created_success2["id"])
    end
  end
  ...
  describe 'FETCH_ASSOCIATED_MODELS' do
    it 'fetches the associated models to the newly created result' do
      created_knowledge_node_student = DomoscioViz::KnowledgeNodeStudent.fetch(created_failure["knowledge_node_student_id"])
